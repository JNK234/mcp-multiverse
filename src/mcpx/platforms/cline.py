...
class ClineAdapter(PlatformAdapter):
    ...
    ABOUTME: Implements PlatformAdapter protocol for Cline
    ...
    def save_project(self, servers: dict[str, MCPServer], project_dir: Path) -> None:
        ...
        ABOUTME: Cline doesn't support project-level configs
        ABOUTME: Raises NotImplementedError
        """
        raise NotImplementedError("Cline doesn't support project-level MCP configs")
