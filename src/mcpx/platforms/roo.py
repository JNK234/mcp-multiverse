...
class RooAdapter(PlatformAdapter):
    """Adapter for Roo Code VS Code extension (rooveterinaryinc.roo-cline).

    ABOUTME: Implements PlatformAdapter protocol for Roo Code
    ABOUTME: Uses cline_mcp_settings.json in globalStorage
    """
    ...
    def save_project(self, servers: dict[str, MCPServer], project_dir: Path) -> None:
        ...
        roo_dir = project_dir / ".roo"
        project_config = roo_dir / "mcp.json"
