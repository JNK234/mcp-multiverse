# Tests for Cline platform adapter
import json
...
def test_cline_load_servers(tmp_path: Path) -> None:
...
def test_cline_save_creates_file(tmp_path: Path) -> None:
...
def test_cline_save_adds_required_defaults(tmp_path: Path) -> None:
...
def test_cline_save_preserves_env(tmp_path: Path) -> None:
...
def test_cline_save_replaces_all(tmp_path: Path) -> None:
...
def test_cline_save_updates_existing(tmp_path: Path) -> None:
...
def test_cline_roundtrip(tmp_path: Path) -> None:
...
def test_cline_adapter_protocol_compliance(tmp_path: Path) -> None:
    """Test ClineAdapter implements PlatformAdapter protocol correctly."""
...
def test_cline_json_format(tmp_path: Path) -> None:
...
def test_cline_empty_env_not_written(tmp_path: Path) -> None:
...
def test_cline_load_ignores_vs_code_fields(tmp_path: Path) -> None:
